    ...
    try:
        ...
        for group in student_groups:
            ...
            for student_id in student_ids:
                ...
                current_timestamp = int(datetime.now().timestamp() * 1000)  # 获取当前时间戳（毫秒）
                ...
                tenant_data = (
                    ...
                    None, "Qwen/Qwen2.5-7B-Instruct@SILICONFLOW", "BAAI/bge-large-zh-v1.5@BAAI", "", "", "", None,
                ...
                tenant_llm_data = (
                    ...
                    "SILICONFLOW", "chat", "Qwen/Qwen2.5-7B-Instruct", "sk-tknnkbdfeheiymilvyzidvjmxlaorwgxcgisoabcobrlpsfo", "", 32768, 0
                )
